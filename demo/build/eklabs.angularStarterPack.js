...
angular.module('eklabs.angularStarterPack.formProject',[
    'ui.ace'
]);
'use strict';

angular.module('eklabs.angularStarterPack.formProject')
    .directive('myFormProject', ['$log',function($log){
        return {
            templateUrl : 'eklabs.angularStarterPack/modules/form-project/directives/project/view.html',
            scope : {
                json        : '=?',
                callback    : '=?',
                options     : '=?',
